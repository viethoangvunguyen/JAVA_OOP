...
public class Order {
    ...
    public DigitalVideoDisc getALuckyItem() {
        ...
        int random = rd.nextInt(this.qtyOrdered);
...
//        System.out.println(nbOrders);
    ...
    public void showInformation() {
        ...
        // Sản phẩm miễn phí
        DigitalVideoDisc lucky_dvd = getALuckyItem();
        System.out.println("Lucky DVD: " + lucky_dvd.getTitle());

        for (int i = 0; i < nbOrders; i++) {
            if (itemsOrdered[i].getTitle().equalsIgnoreCase(lucky_dvd.getTitle())) {
                continue;
            }
